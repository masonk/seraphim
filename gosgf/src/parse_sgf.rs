...
mod __parse__Collection {
    ...
    ) -> Option<Result<GoCollection,__lalrpop_util::ParseError<usize, Token<'input>, &'static str>>>
    {
        let __nonterminal = match -__action {
            ...
            2 => {
                // Collection = GameTree+ => ActionFn(19);
            ...
            3 => {
                // GameTree = r#"\\("#, Sequence, r#"\\)"# => ActionFn(20);
            ...
            4 => {
                // GameTree = r#"\\("#, Sequence, GameTree+, r#"\\)"# => ActionFn(21);
